...
const Banner = () => {
    return (
        <div className='group'>
            ...
            <div>
                <h1 className='text-xl font-semibold md:text-2xl transition duration-500  group-hover:underline tracking-wide '>VR Is the Use of Computer Technology to Create a Simulated Environment.</h1>
